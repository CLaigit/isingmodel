...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{M.eps}
\caption{Expectation value of magnetization, with lattice size $256 \times 256$, take $1000$ warmup steps, and $1000$ measurement steps, measure for temperature ranging from $1.0$ to $5.0$}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=8cm]{HC.eps}
\caption{Expectation value of heat capacity, with lattice size $256 \times 256$, take $1000$ warmup steps, and $1000$ measurement steps, measure for temperature ranging from $1.0$ to $5.0$}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=8cm]{MS.eps}
\caption{Expectation value of magnetization susceptibility, with lattice size $256 \times 256$, take $1000$ warmup steps, and $1000$ measurement steps, measure for temperature ranging from $1.0$ to $5.0$}
\end{figure}
